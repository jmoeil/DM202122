...
\begin{remark}
  Les opérateurs sont indiqués $\bm{gras}$, et $\doteq$ est signifie "égal par définition à".
\end{remark}
...
On introduit les opérateurs déplacement - tel que défini par \eqref{eq:operateur deplacement} - lié aux opérateurs $\bm{a},\bm{b},\bm{A}$ et $\bm{B}$.
...
\end{align}
  \item \emph{Lien entre $\bm{D}_A$ et $\bm{D}_a$,$\bm{D}_b$}.
  \item \emph{Lien entre $\bm{D}_B$ et $\bm{D}_a$,$\bm{D}_b$}.
